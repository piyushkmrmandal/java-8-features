...
public class StudentDataBase {
    ...
    public static Supplier<Student> studentSupplier = () -> {
        ...
        Student student = new Student("Piyush",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"), 4);
    ...
    public static List<Student> getAllStudents(){
         ...
         * 2nd grade students
         */
        Student student1 = new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"), 7);
         ...
         * 4th grade students
         */
        Student student5 = new Student("Sophia",4,3.5,"female", Arrays.asList("swimming", "dancing","football"), 13);
